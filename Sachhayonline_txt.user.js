...
(function($, window, document, undefined) {
    ...
    function saveEbook() {
        ...
        var ebookTitle = $('.inner h3').text().trim(),
        ...
        $.get(chapId)
            .done(function (response) {
                ...
                var $data = $(response),
                    ...
                    $notContent = $chapter.find('iframe, script, style, ul.chapter-nav, form, h3:first');
